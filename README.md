# SimulateDev
Run cutting-edge AI coding IDEs such as Cursor, Devin, and Claude Code with automated workflows.
...
- **IDE Requirements**: Ensure your coding IDEs (Cursor, Windsurf, Claude Code) are already installed and ready to use. SimulateDev doesn't handle IDE setup or installation (for now).

# SimulateDev
Automate cutting-edge AI coding IDEs such as Cursor, Devin, and Claude Code for streamlined development workflows.
...
| `custom` | Custom coding tasks with your own prompt | Need specific functionality or have custom requirements (see [Custom Single-Agent Tasks](#2--custom-single-agent-tasks) section below) |
...
4. **Execute**: Sends your custom coding task to the agent
